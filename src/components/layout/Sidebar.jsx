  ...
  return (
    <aside className="hidden md:flex flex-col w-64 fixed left-0 top-16 bottom-0 bg-surface border-r border-outline-variant/15 p-6 gap-8">
      <div className="flex flex-col gap-2">
        <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary-container text-white transition-all shadow-lg shadow-primary/10" href="#">
          <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>dashboard</span>
          <span className="font-medium">Dashboard</span>
        </a>
        <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-on-surface-variant hover:bg-surface-container-low transition-all" href="#">
