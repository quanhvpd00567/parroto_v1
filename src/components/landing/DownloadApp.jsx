    ...
    <section className="py-24 px-6">
      <div className="max-w-7xl mx-auto bg-primary rounded-[3rem] p-12 md:p-24 overflow-hidden relative text-white">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-primary-fixed/80 text-xl max-w-2xl mb-12">Tải ứng dụng Vocera và bắt đầu hành trình chinh phục tiếng Anh ngay hôm nay trên cả iOS và Android.</p>
