      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a className="text-sm font-inter text-slate-500 hover:text-primary transition-colors" target='_blank' rel="noopener noreferrer" href="/privacy-policy">Privacy Policy</a>
            <a className="text-sm font-inter text-slate-500 hover:text-primary transition-colors"  target='_blank' rel="noopener noreferrer" href="/terms-of-service">Terms of Service</a>
          </div>
          <div className="flex flex-col gap-3">
            <p className="font-bold text-on-surface text-sm">Support</p>
            <a className="text-sm font-inter text-slate-500 hover:text-primary transition-colors"  target='_blank' rel="noopener noreferrer" href="/help-center">Help Center</a>
