  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
      ...
      <div className="w-full mb-6 flex flex-col items-center text-center">
        <span className="text-secondary font-headline font-extrabold tracking-widest uppercase text-[10px] mb-2">Mastery Session</span>
        <h1 className="text-3xl font-headline font-extrabold text-on-surface mb-6 tracking-tight">Vocabulary Retention</h1>
        <div className="w-full max-w-md">
          <div className="flex justify-between items-end mb-2">
            <span className="text-on-surface-variant font-medium text-xs">Session Progress</span>
            <span className="text-primary font-headline font-bold text-base">{progress}<span className="text-on-surface-variant/40 font-normal">/{total}</span></span>
          </div>
      ...
      <div className="flex items-center gap-6 w-full justify-center">
        ...
        {/* Main Card Container */}
        <div className="relative w-full max-w-xl aspect-[1.4/1] group cursor-pointer" onClick={() => setIsFlipped(!isFlipped)}>
          ...
          <div className="relative h-full w-full bg-surface-container-lowest rounded-[2.5rem] ambient-shadow flex flex-col items-center justify-center p-8 border border-outline-variant/15 overflow-hidden">
            ...
            {/* Content - Front/Back logic simplified for now */}
            {!isFlipped ? (
      ...
      <div className="mt-10 flex items-center gap-8">
        ...
        <button className="group flex flex-col items-center gap-3" onClick={onNext}>
      ...
      <div className="w-full max-w-4xl mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-surface-container-low p-6 rounded-xl border border-outline-variant/10">
          ...
          <p className="text-on-surface-variant text-sm leading-relaxed">Focus on the pattern of the word and its unique pronunciation to build a mental bridge.</p>
        </div>
      </div>
    </div>
  );
