...
const ProfileActions = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-end gap-4 pt-8">
      ...
      <button
        className="w-full md:w-auto px-12 py-4 bg-gradient-to-br from-primary to-primary-container text-on-primary font-bold text-lg rounded-xl shadow-[0_8px_24px_rgba(0,40,142,0.2)] hover:brightness-110 active:scale-95 transition-all"
        type="submit"
      >
        Save Changes
      </button>
