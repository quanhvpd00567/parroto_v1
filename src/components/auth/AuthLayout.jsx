      ...
      <footer className="bg-slate-100 dark:bg-slate-900 w-full py-12 px-6 mt-auto">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 max-w-7xl mx-auto">
          ...
          <div className="flex gap-8">
            <a className="font-body text-sm tracking-wide text-slate-500 dark:text-slate-400 hover:text-secondary transition-all" target='_blank' rel="noopener noreferrer" href="/privacy-policy">Privacy Policy</a>
            <a className="font-body text-sm tracking-wide text-slate-500 dark:text-slate-400 hover:text-secondary transition-all" target='_blank' rel="noopener noreferrer" href="/terms-of-service">Terms of Service</a>
            <a className="font-body text-sm tracking-wide text-slate-500 dark:text-slate-400 hover:text-secondary transition-all" target='_blank' rel="noopener noreferrer" href="/help-center">Help Center</a>
          </div>
        </div>
      </footer>
    </div>
